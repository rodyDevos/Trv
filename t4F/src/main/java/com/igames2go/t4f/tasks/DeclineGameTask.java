...
public class DeclineGameTask extends AsyncTask<Void, Void, String> {
    ...
    public DeclineGameTask(Activity activity, String gameId, boolean toShowDialog,
...
//        String url = "http://www.trivia4friends.com/t4fapi/gamev2dev.phpl?f=getGameAlert&gamid=1531&plaid=187";
        String url = String
                .format(activity.getString(R.string.game_url)+"?f=setDecline&gamid=%s&plaid=%s",
                        gameId,playerId);
         Log.e(TAG,"url::  "+url);
        try {
